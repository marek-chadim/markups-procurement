...
**Working paper under revision. The estimates produced by this pipeline are preliminary and should not be cited from this repository.**

The completed, examined result is the thesis (Stockholm School of Economics, 2024): firm markups rise by approximately 15% during procurement contract years, on a 2006–2021 panel of Czech construction firms, with the treatment effect declining from around 30% in 2006 to 10% in 2021 — consistent with institutional improvements and increasing efficiency in Czech public spending. Thesis PDFs, abstract and analysis code are at [marek-chadim/thesis](https://github.com/marek-chadim/thesis).

The working paper extends that thesis with a nine-method robustness program, external-instrument identification and misspecification diagnostics. The current draft is available on request.
...
- `4_paper/output/markups_procurement.pdf` — the working paper
- `3_slides/output/slides.pdf` — beamer presentation

## Data

- **MagnusWeb** (Czech firm financials, CZ-NACE F): 1,521 construction firms, 9,164 firm-year observations
- **Datlab** (Czech procurement register): contract values, bidder identities, tender types
- **Orbis** (Bureau van Dijk, WRDS): 275K firms, 1.3M firm-year observations, all industries
